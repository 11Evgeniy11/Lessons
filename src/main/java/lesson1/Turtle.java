...
public class Turtle implements Participant {
    ...
    public Turtle(String name, int maxRunDistance, int maxJumpHeight, int maxSwimDistance) {
        this.name = name;
    ...
    public String toString() {
        return "Черепаха " + name + " : " + (isOnDistance() ? "на дистанции" : "сошел с дистанции");
    }
}